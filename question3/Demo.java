...
public class Demo {
	...
	void showDetails(Month m) {
		...
		try {
			...
			case JUN: System.out.println("This is the 6th Month of the Year Jun"); 
			
			   break;
			case JUL: System.out.println("This is the 7th Month of the Year July"); 
			
			   break;
			case AUG: System.out.println("This is the 8th Month of the Year Augest"); 
			
			   break;
			case SEP: System.out.println("This is the 9th Month of the Year September"); 
			
			   break;
			case OCT: System.out.println("This is the 10thd Month of the Year October"); 
